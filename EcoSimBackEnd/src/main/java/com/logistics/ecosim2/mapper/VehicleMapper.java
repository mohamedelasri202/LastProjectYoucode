...
public class VehicleMapper {
    ...
    public VehicleDTO toDTO(Vehicle vehicle) {
        ...
        dto.setOfficialEfficiency(vehicle.getOfficialEfficiency());
        dto.setTankCapacity(vehicle.getTankCapacity());
        return dto;
    }
    ...
    public Vehicle toEntity(VehicleDTO dto) {
        ...
        vehicle.setOfficialEfficiency(dto.getOfficialEfficiency());
